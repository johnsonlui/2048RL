...
class Game:
    ...
    def reset(self, cols=4, rows=4):
        self.grid_array = np.zeros(shape=(rows, cols), dtype='float32')
        ...
        self.n_features = self.grid_array.shape

        return self.grid_array

    def step(self, direction):
        reward = self.move(direction)
        # Return state_after_action, reward, done
        return self.grid_array, reward, self.end, {}
